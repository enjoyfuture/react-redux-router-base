/**
 * eslint rules 整理，基于 eslint v5.0.1，eslint-plugin-react v7.10.0，后续会持续升级的
...
module.exports = {
  "rules": {
    ...
    "max-classes-per-file": [2, 1], // 开启后，每个文件只能定义一个 class 类
    ...
    "multiline-comment-style": 2, // 代码注释规范
    ...
    "prefer-object-spread": 2, // 使用 Object.assign 时，第一个参数应该是已有的对象变量，而非静态常量
    ...
    "react/destructuring-assignment": 0, // 使用 es6 新语法，析构方式
    ...
    "react/no-unsafe": 2, // 在 react 组件中不要使用 UNSAFE 开头的方法，比如 UNSAFE_componentWillMount、 UNSAFE_componentWillReceiveProps、UNSAFE_componentWillUpdate()，https://reactjs.org/docs/react-component.html#unsafe_componentwillmount
    ...
    "react/jsx-child-element-spacing": 2, // 元素之间如果需要空格时，需要显示设置，因为 jsx 编译后会删除掉 dom  之间的空格的
    ...
    "react/jsx-max-depth": [2, {"max": 8}], // 嵌套最大深度
    ...
    "react/jsx-one-expression-per-line": 0, // 每个表达式应该写在一行
    "react/jsx-curly-brace-presence": 0, // 是否使用 {} 来给属性或 children 来赋值
