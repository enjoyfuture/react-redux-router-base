      ...
      <div className={mainCss('container', 'mt-1')}>
        <ul className={mainCss('nav', 'nav-tabs', 'mb-2')}>
          <li className={mainCss('nav-item')}>
            <Link className={mainCss('nav-link')} activeClassName={mainCss('active')} to="/person">Person</Link>
          </li>
          <li className={mainCss('nav-item')}>
            <Link className={mainCss('nav-link')} activeClassName={mainCss('active')} to="/film">Film</Link>
          </li>
        </ul>
